...
export const draft = (overrides: Partial<Draft> = {}, sections?: DraftSection[]): Draft => {
  ...
  return {
    ...
    version: 4,
    updatedAt: '2026-05-01T06:00:00.000Z',
    layoutPresets: ['FEATURED_STACK', 'TWO_UP', 'THREE_UP', 'FOUR_UP', 'GRID', 'COMPACT_LIST', 'HORIZONTAL_LIST', 'IMAGE_LED', 'TEXT_LED'],
    cardVariants: ['AUTO', 'featured', 'large', 'horizontal', 'compact', 'image-top', 'text-only', 'video', 'opinion', 'standard'],
    sourceTypes: ['MANUAL', 'LATEST', 'CATEGORY', 'TAG', 'LOCATION'],
